...
summary: "Кирара — краткий справочный материал GenshinTop: стихия Дендро, оружие «Одноручное». Без копипасты текстов талантов из клиента."
gameVersion: "6.x"
...
**Кирара** — герой стихии **Дендро** с оружием типа «Одноручное». Это **редакционный профиль**: без копирования полного текста талантов из клиента — только порядок мыслей и ссылки на опорные материалы.
