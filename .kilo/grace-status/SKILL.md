...
- [ ] `docs/AGENTS.md` — семантическая карта и принципы GRACE
- [ ] `grace/knowledge-graph/knowledge-graph.xml` — version and module count
- [ ] `grace/requirements/requirements.xml` — version and UseCase count
- [ ] `grace/technology/technology.xml` — version and stack summary
- [ ] `grace/plan/development-plan.xml` — version and module count
- [ ] `grace/verification/verification-plan.xml` — version and verification entry count
...
- If no requirements — "Define requirements in grace/requirements/requirements.xml"
