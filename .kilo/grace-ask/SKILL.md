...
2. `grace/knowledge-graph/knowledge-graph.xml` — module map, dependencies, exports
3. `grace/requirements/requirements.xml` — use cases and requirements
4. `grace/technology/technology.xml` — stack, runtime, libraries
5. `grace/plan/development-plan.xml` — phases, modules, contracts
6. `grace/verification/verification-plan.xml` — tests, traces, log markers, and execution gates
