...
summary: "Кавех — краткий справочный материал GenshinTop: стихия Дендро, оружие «Двуручное». Без копипасты текстов талантов из клиента."
gameVersion: "6.x"
...
**Кавех** — герой стихии **Дендро** с оружием типа «Двуручное». Это **редакционный профиль**: без копирования полного текста талантов из клиента — только порядок мыслей и ссылки на опорные материалы.
