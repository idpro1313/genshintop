...
summary: "Часка — краткий справочный материал GenshinTop: стихия Анемо, оружие «Лук». Без копипасты текстов талантов из клиента."
gameVersion: "6.x"
...
**Часка** — герой стихии **Анемо** с оружием типа «Лук». Это **редакционный профиль**: без копирования полного текста талантов из клиента — только порядок мыслей и ссылки на опорные материалы.
