...
summary: "Эола — краткий справочный материал GenshinTop: стихия Крио, оружие «Двуручное». Без копипасты текстов талантов из клиента."
gameVersion: "6.x"
...
**Эола** — герой стихии **Крио** с оружием типа «Двуручное». Это **редакционный профиль**: без копирования полного текста талантов из клиента — только порядок мыслей и ссылки на опорные материалы.
