...
- **Решение:** PATCH **1.5.2** — контент и утилиты пайплайна; редиректы nginx уже были в дереве после **1.5.1**. Две группы **`mergeCandidatesByTitle`** без «бездатного» slug остаются ручными (**WaveWarning** в скрипте).
