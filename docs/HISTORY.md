...
- **Файлы:** `src/pages/characters/*.astro`, `src/pages/guides/*.astro`, `src/pages/lootbar/**`, `src/pages/404.astro`, `src/pages/editorial-policy.astro`, `src/pages/partnership-disclosure.astro`, `src/components/*Hub*.astro`, `src/components/LootBar*.astro`, `src/content.config.ts`, `src/content/guides/*.md`, `src/layouts/BaseLayout.astro`, `src/lib/character-hub.ts`, `src/lib/guide-hub.ts`, `src/lib/partners.ts`, `src/lib/seo.ts`, `deploy/nginx-docker.conf`, `VERSION`, `package.json`, `package-lock.json`, `docs/HISTORY.md`
