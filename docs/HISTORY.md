...
- **Решение:** удалён монолитный `lootbar.astro` в пользу `lootbar/index.astro`; сборку локально не запускали по правилу проекта.
