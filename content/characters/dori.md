...
summary: "Дори — краткий справочный материал GenshinTop: стихия Электро, оружие «Двуручное». Без копипасты текстов талантов из клиента."
gameVersion: "6.x"
...
**Дори** — герой стихии **Электро** с оружием типа «Двуручное». Это **редакционный профиль**: без копирования полного текста талантов из клиента — только порядок мыслей и ссылки на опорные материалы.
