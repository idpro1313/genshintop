...
summary: "Ху Тао — краткий справочный материал GenshinTop: стихия Пиро, оружие «Древковое». Без копипасты текстов талантов из клиента."
gameVersion: "6.x"
...
**Ху Тао** — герой стихии **Пиро** с оружием типа «Древковое». Это **редакционный профиль**: без копирования полного текста талантов из клиента — только порядок мыслей и ссылки на опорные материалы.
