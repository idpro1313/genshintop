...
summary: "Цзы Бай — краткий справочный материал GenshinTop: стихия Гео, оружие «Одноручное». Без копипасты текстов талантов из клиента."
gameVersion: "6.x"
...
**Цзы Бай** — герой стихии **Гео** с оружием типа «Одноручное». Это **редакционный профиль**: без копирования полного текста талантов из клиента — только порядок мыслей и ссылки на опорные материалы.
