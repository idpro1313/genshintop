...
summary: "Итто — краткий справочный материал GenshinTop: стихия Гео, оружие «Двуручное». Без копипасты текстов талантов из клиента."
gameVersion: "6.x"
...
**Итто** — герой стихии **Гео** с оружием типа «Двуручное». Это **редакционный профиль**: без копирования полного текста талантов из клиента — только порядок мыслей и ссылки на опорные материалы.
